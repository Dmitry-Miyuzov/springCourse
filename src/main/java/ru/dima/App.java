...
public class App {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            Важно.
            Мы можем описывать также бины в xml конфигурации.
            И для 1 контейнера указать конфигурацию одного и того же типа с типом синглтон - но с разными айдишниками.
            Это будет 2 разных бина. Тоесть под понятием скоупа можем понимать - определение скоупа конфигурации.
         */
